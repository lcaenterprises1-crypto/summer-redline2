...
Patch notes: v1.6 - Full Athlete Today Framework: Today now supports Throwing, Hitting, Physical Performance, Recovery, lane-based quick logs, and a basic daily stress check.

Roadmap:
- v1.7 - Hitting Integration
