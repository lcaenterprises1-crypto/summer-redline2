...
Patch notes: v1.7.1 - Hitting text and logic polish: clearer Contact Quality guidance, better high-intent labels, optional exact swing count, and softer warning-pattern language with limited data.
